<template>
    <div>
        <h4>一、总则</h4>
        <p>1.1 LINK租界的所有权和运营权归上海派域酒店管理有限公司所有。</p>
        <p>1.2 用户在注册之前，应当仔细阅读本协议，并同意遵守本协议后方可成为注册用户。一旦注册成功，则用户与LINK租界之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。</p>
        <p>1.3 本协议则可由LINK租界随时更新，用户应当及时关注并同意本站不承担通知义务。本站的通知、公告、声明或其它类似内容是本协议的一部分。</p>
        <h4>二、服务内容</h4>
        <p>2.1 LINK租界的具体内容由本站根据实际情况提供。</p>
        <p>2.2 本站仅提供相关的网络服务，除此之外与相关网络服务有关的设备(如个人电脑、手机、及其他与接入互联网或移动网有关的装置)及所需的费用(如为接入互联网而支付的电话费及上网费、为使用移动网而支付的手机费)均应由用户自行负担。</p>
        <h4>三、用户帐号</h4>
        <p>3.1 经本站注册系统完成注册程序并通过身份认证的用户即成为正式用户，可以获得本站规定用户所应享有的一切权限；未经认证仅享有本站规定的部分会员权限。LINK租界有权对会员的权限设计进行变更。</p>
        ...
        <span class="block">(1)违反宪法确定的基本原则的；</span>
        <span class="block">(2)危害国家安全，泄漏国家机密，颠覆国家政权，破坏国家统一的；</span>
        <span class="block">(3)损害国家荣誉和利益的；</span>
        <span class="block">(4)煽动民族仇恨、民族歧视，破坏民族团结的；</span>
        <span class="block">(5)破坏国家宗教政策，宣扬邪教和封建迷信的；</span>
        <span class="block">(6)散布谣言，扰乱社会秩序，破坏社会稳定的；</span>
        <span class="block">(7)散布淫秽、色情、赌博、暴力、恐怖或者教唆犯罪的； </span>
        <span class="block">(8)侮辱或者诽谤他人，侵害他人合法权益的；</span>
        <span class="block">(9)煽动非法集会、结社、游行、示威、聚众扰乱社会秩序的；</span>
        <span class="block">(10)以非法民间组织名义活动的；</span>
        <span class="block">(11)含有法律、行政法规禁止的其他内容的。</span>
        ...
        <span class="block">(1)不得为任何非法目的而使用网络服务系统； </span>
        <span class="block">(2)遵守所有与网络服务有关的网络协议、规定和程序；</span>
        <span class="block">(3)不得利用本站进行任何可能对互联网的正常运转造成不利影响的行为；</span>
        <span class="block">(4)不得利用本站进行任何不利于本站的行为。</span>
        ...
        <span class="block">(1)事先获得用户的明确授权；</span>
        <span class="block">(2)根据有关的法律法规要求；</span>
        <span class="block">(3)按照相关政府主管部门的要求；</span>
        <span class="block">(4)为维护社会公众的利益。</span>
        ...
        <h4>六、版权声明</h4>
        <p>6.1 本站的文字、图片、音频、视频等版权均归上海派域酒店管理有限公司享有或与作者共同享有，未经本站许可，不得任意转载。</p>
        <p>6.2 本站特有的标识、版面设计、编排方式等版权均属上海派域酒店管理有限公司享有，未经本站许可，不得任意复制或转载。 </p>
        <p>6.3 使用本站的任何内容均应注明“来源于LINK租界”及署上作者姓名，按法律规定需要支付稿酬的，应当通知本站及作者及支付稿酬，并独立承担一切法律责任。</p>
        ...
        <h4>七、责任声明</h4>
        <p>7.1 用户明确同意其使用本站网络服务所存在的风险及一切后果将完全由用户本人承担，LINK租界对此不承担任何责任。 </p>
        ...
        <span class="block">(1)本站向用户免费提供的各项网络服务；</span>
        <span class="block">(2)本站向用户赠送的任何产品或者服务。</span>
        ...
        <p>8.3 本协议解释权及修订权归上海派域酒店管理有限公司所有。</p>
    </div>
</template>
<script>
</script>
